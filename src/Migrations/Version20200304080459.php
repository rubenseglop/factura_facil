 ...
 */
final class Version20200304080459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill ADD amount_iva DOUBLE PRECISION NOT NULL, ADD amount_without_iva DOUBLE PRECISION NOT NULL, ADD total_invoice_amount DOUBLE PRECISION NOT NULL, CHANGE client_id client_id INT DEFAULT NULL');
