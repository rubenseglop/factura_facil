 ...
 */
final class Version20200304075103 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill CHANGE client_id client_id INT DEFAULT NULL, CHANGE amount_iva amount_iva NUMERIC(5, 2) NOT NULL, CHANGE amount_without_iva amount_without_iva NUMERIC(5, 2) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill CHANGE client_id client_id INT DEFAULT NULL, CHANGE amount_iva amount_iva INT NOT NULL, CHANGE amount_without_iva amount_without_iva INT NOT NULL');
        $this->addSql('ALTER TABLE bill_line CHANGE product_id product_id INT DEFAULT NULL');
