 ...
 */
final class Version20200304075445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill DROP total_invoice_amount, DROP amount_without_iva, CHANGE client_id client_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill ADD total_invoice_amount NUMERIC(5, 2) NOT NULL, ADD amount_without_iva NUMERIC(5, 2) NOT NULL, CHANGE client_id client_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE bill_line CHANGE product_id product_id INT DEFAULT NULL');
