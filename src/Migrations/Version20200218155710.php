 ...
 */
final class Version20200218155710 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill_line ADD bill_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE client ADD company_id INT NOT NULL, ADD status TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_7A2119E3979B1AD6 ON bill');
        $this->addSql('ALTER TABLE bill_line DROP FOREIGN KEY FK_220BDC5C1A8C12F5');
        $this->addSql('DROP INDEX IDX_220BDC5C1A8C12F5 ON bill_line');
        $this->addSql('ALTER TABLE bill_line DROP bill_id');
        $this->addSql('ALTER TABLE client DROP FOREIGN KEY FK_C7440455979B1AD6');
        $this->addSql('DROP INDEX IDX_C7440455979B1AD6 ON client');
        $this->addSql('ALTER TABLE client DROP company_id, DROP status');
